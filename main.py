...
class MI(QWidget):
    ...
    def mousePressEvent(self, event):
        ...
        if event.button() == Qt.LeftButton:
            ...
            if self.pos().x()+self.sp.pos().x()-self.mouse.pos().x()>-35 and self.pos().x()+self.sp.pos().x()-self.mouse.pos().x()<0 and self.pos().y()+self.sp.pos().y()-self.mouse.pos().y()>-35 and self.pos().y()+self.sp.pos().y()-self.mouse.pos().y()<0 and len(self.fileslist)!=0:
                ...
                self.sp.movie.stop()
                self.mu.movie.start()
            if self.pos().x()+self.nx.pos().x()-self.mouse.pos().x()>-20 and self.pos().x()+self.nx.pos().x()-self.mouse.pos().x()<0 and self.pos().y()+self.nx.pos().y()-self.mouse.pos().y()>-20 and self.pos().y()+self.nx.pos().y()-self.mouse.pos().y()<0 and len(self.fileslist)!=0:
                self.bn=True
                ...
                self.bn=False
            if self.pos().x()+self.bc.pos().x()-self.mouse.pos().x()>-20 and self.pos().x()+self.bc.pos().x()-self.mouse.pos().x()<0 and self.pos().y()+self.bc.pos().y()-self.mouse.pos().y()>-20 and self.pos().y()+self.bc.pos().y()-self.mouse.pos().y()<0 and len(self.fileslist)!=0:
                self.bn=True
                ...
                self.play_music.stop()
                self.bn=False
            if self.pos().x()+self.so.pos().x()-self.mouse.pos().x()>-30 and self.pos().x()+self.so.pos().x()-self.mouse.pos().x()<0 and self.pos().y()+self.so.pos().y()-self.mouse.pos().y()>-30 and self.pos().y()+self.so.pos().y()-self.mouse.pos().y()<0:
    ...
    def timerEvent(self,q):
        ...
        self.QS2.move(self.pos().x(),self.pos().y()+50)
        if self.pos().x()+self.sp.pos().x()-self.mouse.pos().x()>-35 and self.pos().x()+self.sp.pos().x()-self.mouse.pos().x()<0 and self.pos().y()+self.sp.pos().y()-self.mouse.pos().y()>-35 and self.pos().y()+self.sp.pos().y()-self.mouse.pos().y()<0:
            self.sp.movie.start()
            ...
            self.sp.movie.stop()
            self.sp.movie.frame=0
        if self.pos().x()+self.nx.pos().x()-self.mouse.pos().x()>-20 and self.pos().x()+self.nx.pos().x()-self.mouse.pos().x()<0 and self.pos().y()+self.nx.pos().y()-self.mouse.pos().y()>-20 and self.pos().y()+self.nx.pos().y()-self.mouse.pos().y()<0:
            self.nx.movie.start()
            ...
            self.nx.movie.stop()
            self.nx.movie.frame=0
        if self.pos().x()+self.bc.pos().x()-self.mouse.pos().x()>-20 and self.pos().x()+self.bc.pos().x()-self.mouse.pos().x()<0 and self.pos().y()+self.bc.pos().y()-self.mouse.pos().y()>-20 and self.pos().y()+self.bc.pos().y()-self.mouse.pos().y()<0:
            self.bc.movie.start()
